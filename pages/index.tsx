            ...
            <div className="col-12 col-lg-6 mb-3">
              ...
              {[
                ...
                },
                {
                  ...
                  checked: generatorOption.excludeSimilarCharacters,
                },
              ].map((item, key) => {
                return (
                  <div className="row mb-3" key={key}>
                    <label className="col-sm-5 text-white">{item.label}</label>
              ...
              <div className="row">
                <label className="col-sm-5 text-white">Password Blur</label>
                <div className="col-sm-7">
                  <div className="form-check">
                    <input
                      className="form-check-input border-0"
              ...
              {password ? (
                <div className="text-center text-light mt-4">
                  ...
                  >
                    <div
                      style={{
                        filter: generatorOption.blur ? "blur(0.18rem)" : "",
                      }}
                    >
                      {password}
                    </div>
                  ...
                  <div className="mt-3">
                    <div className="d-inline px-2">
                      <Image
                        ...
                        role="button"
                        onClick={handleCopy}
                        src={"/" + iconActions.clipboard.icon}
                        width={22}
                        height={22}
                      />
                    </div>
              ...
              <div className="mt-4 text-center">
                ...
                <div className="text-white ">
                  <small>
                    Password Generator has a new version, please try it{" "}
                    <Link href="https://passwordgenerator.guru">
                      <a className="text-white fw-bold">here</a>
                    </Link>
                    .
                  </small>
                </div>
